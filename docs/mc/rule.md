...
所以咱并不主动阻止这类客户端，但是仍然会对一些行为做出限制：
* 不能以任何行为影响其他玩家，包括但不限于帮助其他玩家探矿，清怪等
* 不能影响服务器运行，例如在船上用vehicleFly之类会导致服务器卡顿的功能
* 任何向其他玩家炫耀，推广辅助程序，展示等行为将被制裁(
* 仍然存在低限度的反作弊，并会踢出参数激进的玩家

***

**举报和报告**  
向管理员报告恶意行为或服务器bug？
* 使用注册邮箱向`ourworld@smyhw.online`发送邮件
* 直接在QQ群中向管理或群主报告
* 使用论坛的[反馈板块](https://bbs.smyhw.online/category/4/%E5%8F%8D%E9%A6%88)